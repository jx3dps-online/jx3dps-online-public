import { 断脉类型 } from './技能类/断脉'
import { 截阳类型 } from './技能类/截阳'
import { 引窍类型 } from './技能类/引窍'
import { 破穴类型 } from './技能类/破穴'
import { 雾海萦空类型 } from './技能类/雾海萦空'
import { 雾刃飞光类型 } from './技能类/雾刃飞光'
import { 骤风令类型 } from './技能类/骤风令'
import { 劈风令类型 } from './技能类/劈风令'
import { 抟风令类型 } from './技能类/抟风令'
import { 雪重花满类型 } from './技能类/雪重花满'
import { 风流云散类型 } from './技能类/风流云散'
import { 一阳来复类型 } from './技能类/一阳来复'
import { 胧雾观花类型 } from './技能类/胧雾观花'
import { 换行类型 } from './技能类/换行'
import { 经脉循行类型 } from './技能类/经脉循行'
