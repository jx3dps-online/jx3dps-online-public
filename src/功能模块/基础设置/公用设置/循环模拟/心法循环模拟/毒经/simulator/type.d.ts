...
import { 蝎心类型 } from './技能类/蝎心'
import { 蛇影类型 } from './技能类/蛇影'
import { 百足类型 } from './技能类/百足'
import { 千丝类型 } from './技能类/千丝'
import { 蟾啸类型 } from './技能类/蟾啸'
import { 灵蛊类型 } from './技能类/灵蛊'
import { 凤凰蛊类型 } from './技能类/凤凰蛊'
import { 连缘蛊类型 } from './技能类/连缘蛊'
import { 灵蛇引类型 } from './技能类/灵蛇引'
import { 蛊虫献祭类型 } from './技能类/蛊虫献祭'
import { 降厄类型 } from './技能类/降厄'
import { 蛊虫狂暴类型 } from './技能类/蛊虫狂暴'
import { 蛇影DOT类型 } from './DOT类/蛇影DOT'
import { 百足DOT类型 } from './DOT类/百足DOT'
import { 蟾啸DOT类型 } from './DOT类/蟾啸DOT'
import { 释灵DOT类型 } from './DOT类/释灵DOT'
