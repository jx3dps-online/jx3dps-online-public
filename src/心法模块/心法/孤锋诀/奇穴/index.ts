  ...
  },
  {
    奇穴列表: [
      ...
      },
      {
        ...
        id: '32580',
        奇穴描述:
          '“破浪三式”套路招式伤害提高10%，击破目标弱点可使自身伤害提高5%，最多10%，持续15秒。',
      },
      {
        奇穴名称: '颂阵',
      ...
      },
      {
        ...
        id: '33027',
        奇穴描述:
          '“孤锋破浪”命中侠士目标后，使其体质降低10%。施展“灭影追风”2秒内下一次施展“孤锋破浪”不会回到“单持武器”状态。',
      },
    ],
  },
  {
    奇穴列表: [
      ...
      },
      {
        ...
        id: '32502',
        奇穴描述:
          '“沧浪三叠”变为单体招式，伤害降低9%，对拥有自身“破绽”的目标施展时将立刻打出三段效果，但将消耗目标一层破绽。',
      },
      {
        奇穴名称: '界破',
        ...
        id: '32512',
        奇穴描述:
          '施展“孤锋破浪”会在原地残留刀气，2秒后会引爆刀气对6尺范围内最多5个目标造成<SUB 34695 1>外功伤害。',
      },
      {
        奇穴名称: '摧朽',
  ...
  },
  {
    奇穴列表: [
      ...
      },
      {
        ...
        id: '34722',
        奇穴描述:
          '自身“破浪三式”套路招式命中有自身“横云断浪”流血效果的目标会造成<SUB 34724 1>外功伤害，每层流血效果使该伤害提高13%。',
      },
      {
        奇穴名称: '遏流',
    ...
    奇穴列表: [
      {
        ...
        id: '32586',
        奇穴描述:
          '施展“孤锋破浪”后将在前方4尺残留6秒斩击刀气，刀气快速向前移动，每0.5秒对半径8尺内的15个敌对目标造成<SUB 32591 1>外功伤害，并添加12秒持续伤害效果，累计攻击20个目标，则刀气被引爆，对半径10尺内10个目标造成<SUB 32591 2>外功伤害，若目标为侠士，则使其下8秒内受到的范围型招式伤害提高15%，刀气每重伤一名敌人，自身则获得35点锐意，该刀气只会存在一道。',
      },
      {
        奇穴名称: '怒锋倾涛',
      ...
      },
      {
        ...
        id: '32665',
        奇穴描述:
          '链接2个有自身破绽且最近的侠士目标，链接期间攻击其中一个目标，另一个目标也将受到70%伤害传递，链接生效范围为25尺，持续6秒。效果时间结束时，对链接的两个目标分别造成基于目标破绽层数的多段伤害，最多4段。',
      },
      {
        奇穴名称: '潋风',
        ...
        id: '36035',
        奇穴描述:
          '施展“决云势”自身获得5秒“潋风”气劲，期间主动施展“流云势法”套路伤害招式命中目标会额外获得20点锐意，并额外触发<SUB 36118 1>外功伤害。',
      },
    ],
  },
  {
    ...
    奇穴列表: [
      {
        ...
        id: '32452',
        奇穴描述:
          '“望云势”调息时间降低5秒，反击时不再需要目标，伤害提高50%，且会对8尺内3个敌对目标造成伤害。',
      },
      {
        奇穴名称: '雾灭',
      ...
      },
      {
        ...
        id: '32511',
        奇穴描述:
          '“横云断浪”调息时间降低6秒，附带“流血”效果持续时间提高12秒。击破非侠士目标“弱点”时，若其持有的自身“破绽”层数低于3层，则额外添加1层“破绽”。',
      },
      {
        奇穴名称: '殊际',
