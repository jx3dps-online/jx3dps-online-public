...
const 奇穴数据: 奇穴列表数据类型[] = [
  {
    奇穴列表: [
      ...
      },
      {
        ...
        id: '40240',
        奇穴描述:
          '蓄力每0.375秒使释放时候增加一支箭矢，松开后立刻回复10%内力值并释放全部蓄力箭矢迅速攻击目标，造成伤害并使目标获得标鹄，对非侠士目标造成伤害提高300%，最多蓄力3秒。蓄力期间每跳会消耗箭袋的一支箭，增强释放时的额外伤害并使目标获得一层“贯穿”。<TALENT 42467 1 >',
      },
      {
        奇穴名称: '佑主',
  ...
  },
  {
    奇穴列表: [
      ...
      },
      {
        ...
        id: '42467',
        奇穴描述:
          '“聚势摧霆”不再充能，调息时间降低3秒，成功施展后使自身获得1层“承契”，命中目标后使目标添加“连珠”持续18秒，最多两层，每层“连珠”期间受到自身的“标鹄”提高20%。<TALENT_CORE 40240 1>',
      },
    ],
  },
  {
    ...
    奇穴列表: [
      {
        ...
        id: '35730',
        奇穴描述:
          '“汇山岚”作用目标数降低2个，不再造成眩晕而是3秒恐惧，施展“汇山岚”后玩家的追击范围会增大2尺。',
      },
      {
        奇穴名称: '诸怀',
  ...
  },
  {
    奇穴列表: [
      ...
      },
      {
        ...
        id: '42469',
        奇穴描述:
          '“乘黄之威”存在期间，上弦星流术全部升级为对应的“白羽流星”强化招式。<TALENT_CORE 42468 1>',
      },
    ],
  },
  {
