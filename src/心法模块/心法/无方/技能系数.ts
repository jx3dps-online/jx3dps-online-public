...
const 技能基础数据: 技能基础数据模型[] = [
  {
    ...
    技能名称: '破',
    统计名称: '破',
    技能伤害系数: 7.421 * 3.0602874755859375,
    技能增益列表: 通用增益,
    //技能等级数据: {
    //  1: { 技能伤害系数: 获取破招实际系数(1048576 * (0.525*1.2 * 2.3 * 1.6 * 1.1 - 1)) },
  ...
  },
  {
    ...
    技能名称: '且待时休',
    统计名称: '且待时休',
    技能伤害系数: 232.50239999999994 * 1.265,
    基础伤害_基础值: 206,
    基础伤害_浮动值: 10,
    技能增益列表: 且待时休增益,
  },
